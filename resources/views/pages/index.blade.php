<x-layout :title="$title">
    ...
    <div class="relative w-full" id="default-carousel" data-carousel="slide">
        ...
        <div class="carousel-images relative overflow-hidden">
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                ...
                <div class="content w-full h-full flex justify-center items-center font-bold">
                    <h1 class="text-[40px] absolute z-[3] text-white uppercase drop-shadow-sm">{{ config('app.name') }}
                    </h1>
                </div>
            </div>
            <!-- Item 2 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                ...
                <div class="content w-full h-full flex justify-center items-center font-bold">
                    <h1 class="text-[40px] absolute z-[3] text-white uppercase">{{ config('app.name') }}</h1>
                </div>
            </div>
            <!-- Item 3 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
    ...
    @unless ($events->count() == 0)
        <div class="events-container w-full px-4 py-11">
            <h2 class="flex justify-center text-center text-xl font-semibold uppercase text-cyan-700">
                <x-heroicon-o-calendar-days class="h-6 w-10 text-cyan-700" />Events
            </h2>
            ...
            <div class="cards-container py-5">
                @foreach ($events as $event)
                    <div class="card slide-up">
                        ...
                        <div class="block">
                            <span class="float-left flex text-sm text-cyan-600"><x-heroicon-o-map-pin
                                    class="h-5 w-4 text-cyan-600" />
                                {{ $event->location }}</span>
                            <i class="float-right flex text-sm text-gray-400"><x-heroicon-o-clock
                                    class="h-5 w-4 text-gray-400" />
                                {{ $event->happning_at }}</i>
                        </div>
    ...
    <div class="about-index-container block w-full px-4 pb-2 pt-10">
        <h2 class="text-center text-[30px] font-semibold uppercase text-cyan-700 mt-[40px] mb-[10px]"><span>About
                Us</span>
        ...
        <div class="inner-about-container px-5 py-3">
            ...
            <div class="quote slide-left">
                <h3>What We Do</h3>
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita reprehenderit quos molestias odit
                    sunt, quo quis
                    delectus minus ea, sit ullam! Quam ipsum odit provident repellendus velit pariatur deserunt
                    quibusdam?
                </p>
                <p>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Delectus, optio cupiditate accusamus quos
                    repellendus aut
                </p>
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro ut sapiente provident modi suscipit
                    iure unde
                </p>
            </div>
        </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide pastor py-25">
                        ...
                        <blockquote class="text-center text-sm text-gray-100">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam rem quisquam voluptates
                            fuga.
                        </blockquote>
                    </div>
                    ...
                    <div class="swiper-slide pastor py-25">
                        <figure>
                            <img src="{{ asset('images/Rev.-Sunday-Olomojare.jpg-5.jpg-6-768x637.jpg') }}"
                                alt="">
                        </figure>
                ...
                @foreach ($posts as $post)
                    <div class="card">
                        ...
                        <div class="block p-1">
                            ...
                            <small class="float-right flex text-gray-400"><x-heroicon-o-clock
                                    class="h-4 w-4 text-gray-400" />
                                {{ $post->created_at }}</small>
                            <h4 class="text-sm font-semibold text-teal-800"><a
                                    href="{{ route('blog.single', $post->id) }}">{{ $post->title }}</a></h4>
                            <div class="overflow-hidden text-ellipsis whitespace-nowrap text-sm text-gray-500">
                                {{ $post->content }}</div>
