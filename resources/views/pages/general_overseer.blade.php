<x-layout :title="$title">
    ...
    <section class="general-overseer-page">
        ...
        <div class="overseer-content px-3 py-16">
            <div class="content">
                <h3 class="text-2xl font-extrabold text-gray-950">Rev Dan Akingbelure</h3>

                <blockquote class="p-2 text-gray-600">
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nisi recusandae possimus obcaecati, a
                        expedita culpa.
                    </p>
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolor facere hic porro itaque
                        praesentium, eum numquam
                        dolore veritatis nam?</p>
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatum ducimus corporis cupiditate,
                        voluptatem
